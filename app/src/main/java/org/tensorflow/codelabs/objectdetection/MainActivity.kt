...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun runObjectDetection(bitmap: Bitmap) {
        Log.d(TAG, "runObjectDetection started") // Log start
        try {
            ...
            // Step 2: Initialize the detector options
            Log.d(TAG, "Initializing ObjectDetectorOptions...")
            val options = ObjectDetector.ObjectDetectorOptions.builder()
                .setMaxResults(5)
                .setScoreThreshold(0.5f) // Use 0.5f for float value
                .build()
            Log.d(TAG, "ObjectDetectorOptions created.")
            ...
            Log.d(TAG, "Detection finished. Results count: ${results.size}")

            // Step 5: Process the detection results
            ...
            debugPrint(results)
            Log.d(TAG, "debugPrint finished.")

        } catch (e: Exception) {
            // Catch any errors that might happen during detection
            Log.e(TAG, "Error running object detection", e)
        }
        Log.d(TAG, "runObjectDetection finished") // Log end
    }
